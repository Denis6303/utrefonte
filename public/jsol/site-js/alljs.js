...
(function (e) {
    ...
    e.fn.bjqs = function (t) {
        var n = {
                ...
                randomstart: !1,
                responsive: !1
            }, r = e.extend({}, n, t), i = this, s = i.find("ul.bjqs"), o = s.children("li"), u = null, a = null, f = null,
            l = null, c = null, h = null, p = null, d = null, v = {
                slidecount: o.length,
                animating: !1,
                paused: !1,
                currentslide: 1,
...
$(function () {
    ...
    // Preloader
    $(".coda-slider").children('.panel').hide().end().prepend('<p class="loading">Loading...<br /><img src="../img/wait-big.gif" alt="loading..." /></p>');
});
var sliderCount = 1;
