...
use App\Repository\StatistiqueClientRepository; // Importer le Repository (nom de classe corrigé)
...
/**
 * Classe qui gère les statistiques spécifiques aux clients.
 *
 * @author Gautier
 */
#[ORM\Entity(repositoryClass: StatistiqueClientRepository::class)] // Nom Repository corrigé
...
class StatistiqueClient
{
    ...
    #[ORM\Column(name: 'idstat', type: Types::INTEGER)] // Nom de colonne conservé
    ...
    // Pas de callback PrePersist ou PreUpdate nécessaire pour les initialisations simples

    // --- Méthode __toString ---
    public function __toString(): string
    {
        // Fournit une représentation textuelle simple de l'objet
        return $this->libStat ?? 'StatistiqueClient #' . $this->id;
    }
}