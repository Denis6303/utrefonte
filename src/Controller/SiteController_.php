...
class SiteController extends AbstractController
{
    ...
    public function indexAction(): Response($locale,$page)
    {        
        ...
        /*$menu = $em->getRepository("admin/Menu")->findOneBy(array('libmenu'=>$page));
    ...
    public function menuAction(): Response($locale, $groupe,$idrub){
       ...
       //var_dump($menuParents);exit;
                   ...
                   if(!empty($menuFilsIDs)){
                        foreach($menuFilsIDs as $mID){
                            ...
                            if ($mFils !=null){
                             ...
                             $image = $em->getRepository("utbAdminBundle:Menu")->getImageTypeMenu($mFils[0]['typeMenu']);
                             $listeLiens[$mp->getLibMenu() . "|".$mp->getUrlExterneMenu(). "|" . $mp->getId() . "|" . $t . "|" . $im. "|".$groupe][] = array(
                                 "id" => $mFils[0]['id'],
        ...
        if($groupe == 1){
               $thisOrdre = $em->getRepository("admin/Ordre")->findOneBy(array("nomTable"=>"MenuParent"));
               //
               $ordre = unserialize($thisOrdre->getOrdre());     			   
    ...
    public function rubriqueAction(): Response($id,$locale,$type,$date,$typecate){        
      ...
      // Pour avoir les solution générale 
       ...
       //var_dump($listeBanniere);exit;
        ...
        if($type==1){
                return $this->render('utbSiteBundle/Site/rubrique.html.twig',array('larubrique'=>$larubrique,'listearticle'=>$listearticle,'solutiongenerale'=>$solutiongenerale,'listesousrub'=>$listesousrub,'locale'=>$locale,'listeBanniere'=>$listeBanniere,'listeactualite'=>$listeactualite,'listefaq'=>$listefaq,'image' => $image,'listecateg'=>$listecateg,'listecorrespondance'=>$listecorrespondance,'notrearticle'=>$notrearticle,));               
        }elseif($type==2){
               return $this->render('utbSiteBundle/Site/rubriqueart.html.twig',array('larubrique'=>$larubrique,'listearticle'=>$listearticle,'solutiongenerale'=>$solutiongenerale,'listesousrub'=>$listesousrub,'locale'=>$locale,'listepublication'=>$listepublication,'listefaq'=>$listefaq,'image' => $image,'listecategorie'=>$listecategorie,'articlecategorie'=>$articlecategorie,'listecateg'=>$listecateg,'articlesousrubrique'=>$articlesousrubrique,'listearticlefirst'=>$listearticlefirst,));            
        }elseif($type==3){
                return $this->render('utbSiteBundle/Site/rubriquearb.html.twig',array('larubrique'=>$larubrique,'listearticle'=>$listearticle,'solutiongenerale'=>$solutiongenerale,'listesousrub'=>$listesousrub,'locale'=>$locale,'listepublication'=>$listepublication,'listefaq'=>$listefaq,'image' => $image,'listecateg'=>$listecateg,));
        }elseif($type==4){           
                 return $this->render('utbSiteBundle/Site/alldocuments.html.twig',array('larubrique'=>$larubrique,'listearticle'=>$listearticle,'solutiongenerale'=>$solutiongenerale,'listesousrub'=>$listesousrub,'locale'=>$locale,'listepublication'=>$listepublication,'natureDoc'=>$natureDoc,'image' => $image,'listecateg'=>$listecateg,));           
        }elseif($type==5){
                  return $this->render('utbSiteBundle/Site/particulier.html.twig',
                              array('larubrique'=>$larubrique,'listearticle'=>$listearticle,'solutiongenerale'=>$solutiongenerale,'listesousrub'=>$listesousrub,'locale'=>$locale,'listeBanniere'=>$listeBanniere,'listeactualite'=>$listeactualite,'listefaq'=>$listefaq,'image' => $image,'listecateg'=>$listecateg,'listecorrespondance'=>$listecorrespondance,'listecorrespondanceEtranger'=>$listecorrespondanceEtranger,));                     
        }elseif($type==6){
                  return $this->render('utbSiteBundle/Site/reseau.html.twig',
                              array('larubrique'=>$larubrique,'listearticle'=>$listearticle,'solutiongenerale'=>$solutiongenerale,'listesousrub'=>$listesousrub,'locale'=>$locale,'listeBanniere'=>$listeBanniere,'listeactualite'=>$listeactualite,'listefaq'=>$listefaq,'articlereseau'=>$articlereseau,'image' => $image,'listecateg'=>$listecateg,));                     
        }elseif($type==7){
                  ...
                  array('larubrique'=>$larubrique,'listearticle'=>$listearticle,'listesousrub'=>$listesousrub,'solutiongenerale'=>$solutiongenerale,'locale'=>$locale,'listeBanniere'=>$listeBanniere,'listeactualite'=>$listeactualite,'listefaq'=>$listefaq,'articlereseau'=>$articlereseau,'listecorrespondance'=>$listecorrespondance,'image' => $image,));                     
        }elseif($type==9){
                  ...
                  return $this->render('utbSiteBundle/Site/rubriqueEpargne.html.twig',array('larubrique'=>$larubrique,'listearticle'=>$listearticle,'solutiongenerale'=>$solutiongenerale,'listesousrub'=>$listesousrub,'locale'=>$locale,'listeBanniere'=>$listeBanniere,'listeactualite'=>$listeactualite,'listefaq'=>$listefaq,'image' => $image,'listecategorie'=>$listecategorie,'articlecategorie'=>$articlecategorie,'listecateg'=>$listecateg,));
        }  elseif($type==12){           
                  return $this->render('utbSiteBundle/Site/particulier_cover.html.twig',array('larubrique'=>$larubrique,'listearticle'=>$listearticle,'solutiongenerale'=>$solutiongenerale,'listesousrub'=>$listesousrub,'locale'=>$locale,'listeBanniere'=>$listeBanniere,'listeactualite'=>$listeactualite,'listefaq'=>$listefaq,'image' => $image,'listecategorie'=>$listecategorie,'articlecategorie'=>$articlecategorie,'listecateg'=>$listecateg,'listecorrespondance'=>$listecorrespondance,'listecorrespondanceEtranger'=>$listecorrespondanceEtranger,'articlepub'=>$articlepub,));
        } elseif($type==13){           
                  return $this->render('utbSiteBundle/Site/rubriqueEntreprise.html.twig',array('larubrique'=>$larubrique,'listearticle'=>$listearticle,'solutiongenerale'=>$solutiongenerale,'listesousrub'=>$listesousrub,'locale'=>$locale,'listeBanniere'=>$listeBanniere,'listeactualite'=>$listeactualite,'listefaq'=>$listefaq,'image' => $image,'listecategorie'=>$listecategorie,'articlecategorie'=>$articlecategorie,'listecateg'=>$listecateg,'listecorrespondance'=>$listecorrespondance,'listecorrespondanceEtranger'=>$listecorrespondanceEtranger,'articlepub'=>$articlepub,));
        } elseif($type==14){           
                  return $this->render('utbSiteBundle/Site/ebox.html.twig',array('larubrique'=>$larubrique,'listearticle'=>$listearticle,'solutiongenerale'=>$solutiongenerale,'listesousrub'=>$listesousrub,'locale'=>$locale,'listepublication'=>$listepublication,'listefaq'=>$listefaq,'image' => $image,'listecategorie'=>$listecategorie,'articlecategorie'=>$articlecategorie,'listecateg'=>$listecateg,'articlesousrubrique'=>$articlesousrubrique,));
        } elseif($type==15){           
                  return $this->render('utbSiteBundle/Site/service.html.twig',array('larubrique'=>$larubrique,'listearticle'=>$listearticle,'solutiongenerale'=>$solutiongenerale,'listesousrub'=>$listesousrub,'locale'=>$locale,'listepublication'=>$listepublication,'listefaq'=>$listefaq,'image' => $image,'listecategorie'=>$listecategorie,'articlecategorie'=>$articlecategorie,'listecateg'=>$listecateg,'articlesousrubrique'=>$articlesousrubrique,));
        } elseif($type==16){           
                  return $this->render('utbSiteBundle/Site/presentationCarteOnglet.html.twig',array('larubrique'=>$larubrique,'listearticle'=>$listearticle,'solutiongenerale'=>$solutiongenerale,'listesousrub'=>$listesousrub,'locale'=>$locale,'listepublication'=>$listepublication,'listefaq'=>$listefaq,'image' => $image,'listecategorie'=>$listecategorie,'articlecategorie'=>$articlecategorie,'listecateg'=>$listecateg,'articlesousrubrique'=>$articlesousrubrique,'listearticlefirst'=>$listearticlefirst,'listecorrespondanceEtranger'=>$listecorrespondanceEtranger,));            
        }elseif($type==17){
                  return $this->render('utbSiteBundle/Site/reseau2.html.twig',
                              array('larubrique'=>$larubrique,'listearticle'=>$listearticle,'solutiongenerale'=>$solutiongenerale,'listesousrub'=>$listesousrub,'locale'=>$locale,'listeBanniere'=>$listeBanniere,'listeactualite'=>$listeactualite,'listefaq'=>$listefaq,'articlereseau'=>$articlereseau,'image' => $image,'listecateg'=>$listecateg,));                     
        } elseif($type==18){           
                  return $this->render('utbSiteBundle/Site/service2.html.twig',array('larubrique'=>$larubrique,'listearticle'=>$listearticle,'solutiongenerale'=>$solutiongenerale,'listesousrub'=>$listesousrub,'locale'=>$locale,'listepublication'=>$listepublication,'listefaq'=>$listefaq,'image' => $image,'listecategorie'=>$listecategorie,'articlecategorie'=>$articlecategorie,'listecateg'=>$listecateg,'articlesousrubrique'=>$articlesousrubrique,));
        } elseif($type==19){           
                  return $this->render('utbSiteBundle/Site/service2.html.twig',array('larubrique'=>$larubrique,'listearticle'=>$listearticle,'solutiongenerale'=>$solutiongenerale,'listesousrub'=>$listesousrub,'locale'=>$locale,'listepublication'=>$listepublication,'listefaq'=>$listefaq,'image' => $image,'listecategorie'=>$listecategorie,'articlecategorie'=>$articlecategorie,'listecateg'=>$listecateg,'articlesousrubrique'=>$articlesousrubrique,));
        } elseif($type==20){           
                   return $this->render('utbSiteBundle/Site/particulier2.html.twig',
                              array('larubrique'=>$larubrique,'listearticle'=>$listearticle,'solutiongenerale'=>$solutiongenerale,'listesousrub'=>$listesousrub,'locale'=>$locale,'listeBanniere'=>$listeBanniere,'listeactualite'=>$listeactualite,'listefaq'=>$listefaq,'image' => $image,'listecateg'=>$listecateg,));                     
        } 
    ...
    public function articleAction(): Response($id,$locale,$type)
    {
        $em = $this->entityManager; 
     ...
     //  fin affichage des  autres images de l'article
        ...
        $listeuser = $this->entityManager
                        ->getRepository('utbUserBundle:User')
                        ->findAll();  
     ...
     * 
     */     
    public function contactAction(): Response($locale,$type) 
    {
               ...
               $request = $request;           
                if ($request->isMethod('POST')) {                   
                    ...
                    $mailmessage = $this->entityManager
                                        ...
                                        ->getMailMessage($uncontact->getMailInternaute()); 
                    ...
                    if ($type == 0){
                        if($recevoir=="oui"){
                                ...
                                $envoimail =  $this->utb_admin.Mailer->sendMessage('fessou-atasse.tevi@utb.com',$mailinternaute, $message->getTitreMessage(),$message->getContenuMessage());                                       
                        }                
                    
                        $envoimail =  $this->utb_admin.Mailer->sendMessage('fessou-atasse.tevi@utb.com',$email, $message->getTitreMessage(),$message->getContenuMessage());                     
                        
                    }
                     return $this->redirect($this->generateUrl("utb_site_homepage"));  
                } 
            if ($type == 0){    
                return $this->render('utbSiteBundle/Site/contact.html.twig', array(
                        'form' => $form->createView(), 'reponse'=>$reponse, 'locale'=>$locale,'listeAgence'=>$listeAgence,'listetheme'=>$listetheme , 
                    ));
            }  else {                              
    ...
    public function newsletterAction(): Response($locale)
    {
    ...
    public function sondageAction(): Response($locale)           
    {
     ...
     * 
     */
    public function rechercheAction(): Response($locale)
    {
           $this->requestStack->getCurrentRequest()Stack->getSession()->set('_locale', $locale); 
    ...
    public function connexionAction(): Response($locale)
    {
    ...
    public function rechFAQAction(): Response($locale,$page)
    {        
    ...
    public function pageAction(): Response($page)
    {
        if ($page ==0){
    ...
    public function souscriptionAction(): Response($locale)
    {
        $this->requestStack->getCurrentRequest()->setLocale($locale);
        $this->requestStack->getCurrentRequest()Stack->getSession()->set('_locale', $locale);
        //$em = $this->entityManager;
    ...
    public function videohdAction(): Response($locale)
    {
        $this->requestStack->getCurrentRequest()->setLocale($locale);
        //$this->requestStack->getCurrentRequest()Stack->getSession()->set('_locale', $locale);
        $this->infoSite($locale);
    ...
    public function infoSite(): Response($locale) {       
   ...
   public function standardAction(): Response($page)
    {
        if ($page == 100){
