...
class RechercheController extends AbstractController {
     ...
     *  
     */
    public function rechercheAbonneAction(): Response($locale) {
    ...
    public function rechercheOperationAction(): Response($idCompte, $post, $page, $idAbonne, $locale) {
    ...
    public function rechercheOperationCompteAction(): Response($idCompte, $idAbonne, $locale) {
    ...
    public function rechercheOperationAdminAction(): Response($imprimer, $afficher,$post,$page,$locale,$cpte,$deb,$fin,$mttde,$mtta,$sens) {
    ...
    public function exporterOperationAdminAction(): Response($locale, $imprimer, $cpte, $deb, $fin, $mttde, $mtta, $sens) {
    ...
    public function rechercheOperationAbonneAction(): Response($idCompte, $idAbonne, $page, $locale, $cpte, $deb, $fin, $mttde, $mtta, $sens) {
  ...
  if ($request->getMethod()=='POST'){
    ...
    public function rechercheOperationEspaceAbonneAction(): Response($page, $imprimer, $afficher,$post, $locale,$cpte,$deb,$fin,$mttde,$mtta,$sens) {
    ...
    public function rechercheHistorikAction(): Response($page, $afficher, $locale,$connecte,$deb,$fin,$typecon,$mois,$an) {
